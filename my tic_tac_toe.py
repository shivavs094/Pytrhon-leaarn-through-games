...
class TicTacToeGame:
    def __int__(self, players=DEFAULT_PLAYER, board_size=BOARD_SIZE):
    ...
    def is_tied(self):
        no_winner = not self._has_winner
        played_move = (move.label for row in self._current_moves for move in row)
    ...
    def play(self, event):
        ...
        if self._game.is_valid_move(move):
            ...
            if self._game.is_tied():
                ...
                self._game.togglr_player()
                msg = f"{self._game.current_player}'s turn"
